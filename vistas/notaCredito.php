              ...
              <tr>
                <td>
                  <div class="btn-container">
                    <span class="btn" id="crearNotaBtn">Generar</span>
                    <div class="message">Realizar una nota de crédito</div>
                  </div>
                </td>
                <td>
                  <div class="btn-container">
                    <span class="btn" id="notasHechasBtn">Consultar</span>
                    <div class="message">Consultar las notas de credito / generar nota de crédito</div>
                  </div>
                </td>
              </tr>
            </tbody>
