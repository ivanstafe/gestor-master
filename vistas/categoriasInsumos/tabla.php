...
<div class="table-container" style="margin-left: auto; margin-right: auto;">
    <table class="table table-hover table-condensed table-bordered" style="text-align: center;" id="tabla-categoriaInsumos">
        <thead>
            <tr>
                <th>Categoria</th>
                <th>Actualizar</th>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabla-categoriaInsumos').DataTable({
            "order": [],
            "language": {
        ...
        $('#tabla-categoriaInsumos thead input').not('#filtro-categoria').prop('disabled', true);
...
<style>
    ...
    #tabla-categoriaInsumos_filter input {
    ...
    #tabla-categoriaInsumos thead th {
        position: relative;
        text-align: center;
    ...
    #tabla-categoriaInsumos thead th div {
        margin-bottom: 0.5em;
    }

    #tabla-categoriaInsumos thead th input {
        position: absolute;
        width: calc(100% - 1em);
    ...
    #tabla-categoriaInsumos tbody tr {
