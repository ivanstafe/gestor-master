...
$sql = "SELECT id_categoria,nombre FROM categoriasProductos";
...
<div class="table-container" style="margin-left: auto; margin-right: auto;">
    <table class="table table-hover table-condensed table-bordered" style="text-align: center;" id="tabla-categoriaProductos">
        <thead>
            <tr>
        ...
        <tbody>
            ...
            <?php while ($ver = mysqli_fetch_row($result)) : ?>
                <tr class="categoria-row" id="<?php echo $ver[0]; ?>">
                    ...
                    <td>
                        <a class="btn btn-warning btn-xs" data-toggle="modal" data-target="#actualizarCategoria" onclick="editaCategoria('<?php echo $ver[0]; ?>','<?php echo $ver[1]; ?>')">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabla-categoriaProductos').DataTable({
            "order": [],
            "language": {
        ...
        $('#tabla-categoriaProductos thead input').not('#filtro-categoria').prop('disabled', true);
...
<style>
    ...
    #tabla-categoriaProductos input,
    #filtro-categoria {
        max-width: 100px;
        text-align: center;
        margin-bottom: 0.5em;
    ...
    #tabla-categoriaProductos_filter input {
        background-color: #ccc;
    }

    /* Estilo para colocar el texto del filtro en la fila adecuada */
    #tabla-categoriaProductos thead th {
        position: relative;
        text-align: center;
    ...
    #tabla-categoriaProductos thead th div {
        margin-bottom: 0.5em;
    }

    #tabla-categoriaProductos thead th input {
        position: absolute;
        width: calc(100% - 1em);
    ...
    #tabla-categoriaProductos tbody tr {
