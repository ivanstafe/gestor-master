...
$sql = "SELECT cnc.id,
            ...
            FROM cabecera_nota_credito cnc
            INNER JOIN clientes c ON cnc.cliente_id = c.id_cliente
            GROUP BY cnc.id";
            ...
            <table class="table table-hover table-condensed table-bordered" style="text-align: center;" id="tabla-ventas">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Notas de crédito</th>
                    </tr>
                ...
                <tbody>
                    <?php while ($ver = mysqli_fetch_row($result)) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="../acciones/notasCredito/crearTicketPdf.php?id=<?php echo $ver[0] ?>" class="btn btn-success btn-sm">
