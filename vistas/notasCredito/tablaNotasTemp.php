...
<div class="">
  <table class="table table-bordered table-hover table-condensed" style="text-align: center;">
    ...
    <tbody>
      ...
      if (isset($_SESSION['tablaNotasTemp'])) {
        $productos_agregados = [];

        foreach ($_SESSION['tablaNotasTemp'] as $key => $producto) {
      ...
      <tr>
        <td colspan="6" class="text-right">
          <span class="btn btn-custom" onclick="crearNota()">
...
<script type="text/javascript">
  ...
  function quitarP(idProducto) {
    $.ajax({
      ...
      url: "../acciones/notasCredito/quitarproducto.php",
