...
?>
	...
	<body>
			...
			<div class="row">
				<div class="col-sm-4">
					...
					<form id="formCategorias">
						...
						<br>
						<a class="btn btn-success btn-custom-agregar" id="btnAgregarCategoria">Agregar</a>
					</form>
				</div>
				<div class="col-sm-6">
			...
			<div class="modal-dialog modal-sm" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" id="btnActualizaCategoria" class="btn btn-success btn-custom-agregar" data-dismiss="modal">Guardar
		...
		<script type="text/javascript" src="../js/categoriasProductos.js"></script>
