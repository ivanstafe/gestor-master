		...
		$(document).ready(function(){
			...
			$('#cargaTablaCategorias').load("../vistas/categoriasInsumos/tabla.php");
			...
			$('#btnAgregarCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:datos,
					url:"../acciones/categoriasInsumos/agregarCategoria.php",
					success:function(r){
						if(r==1){
		...
		$(document).ready(function(){
			$('#btnActualizaCategoria').click(function(){
				...
				$.ajax({
					type:"POST",
					data:datos,
					url:"../acciones/categoriasInsumos/actualizarCategoria.php",
					success:function(r){
						if(r==1){
							$('#cargaTablaCategorias').load("../vistas/categoriasInsumos/tabla.php");
		...
		function eliminaCategoria(idcategoria){
			alertify.confirm('¿Desea eliminar esta categoria?', function(){ 
				$.ajax({
					...
					url:"../acciones/categoriasInsumos/eliminarCategoria.php",
					success:function(r){
						if(r==1){
							$('#cargaTablaCategorias').load("../vistas/categoriasInsumos/tabla.php");
